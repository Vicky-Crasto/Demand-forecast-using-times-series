...
Hence the series is not stationary and needs to be transformed.The variance and seasonal component can be handled with a log transformation.Differencing will help in handling the trend component
